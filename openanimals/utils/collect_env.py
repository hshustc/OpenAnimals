...
def collect_env_info():
    ...
    try:
        import openanimals  # noqa

        data.append(
            ("openanimals", openanimals.__version__ + " @" + os.path.dirname(openanimals.__file__))
        )
    except ImportError:
        data.append(("openanimals", "failed to import"))
